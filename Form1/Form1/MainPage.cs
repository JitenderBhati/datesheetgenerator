...
namespace Form1
{
    public partial class MainPage : Form
    {
        ...
        {
            //var saveFileDialog = (Se.Argument;
                    ...
                    if (!backgroundWorker.CancellationPending)
                    {
                        for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
                        {
                            for (int j = 0; j < dataGridView1.Columns.Count; j++)
                            {
                                ...
                                backgroundWorker.ReportProgress(temp++ * 100 / dataGridView1.Rows.Count);
                            }
                        }
                    }
        ...
        private void backgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            lbl_process.Text = string.Format("Processing.. {0}%", e.ProgressPercentage);
            progressBar.Update();
        }
        ...
        private void backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                Thread.Sleep(100);
                if (MessageBox.Show("Successfully Exported to Excel", "Information", MessageBoxButtons.OK, MessageBoxIcon.Asterisk) == DialogResult.OK)
                {
        ...
        private void btnexport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (saveFileDialog.ShowDialog() != DialogResult.Cancel)
                {
                    ...
                    backgroundWorker.RunWorkerAsync(saveFileDialog);
                    //Microsoft.Office.Interop.Excel.Application ExcelApp = new Microsoft.Office.Interop.Excel.Application();
                    //ExcelApp.Application.Workbooks.Add(Type.Missing);
