    ...
    public partial class MainPage : Form
    {
        ...
        private void txt_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    flag = true;
                    dataGridView1[1, index].Value = dtp.Text.ToString();
                }
            }
        ...
        private void btnexport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (saveFileDialog.ShowDialog() != DialogResult.Cancel)
                {
                    ...
                    ExcelApp.Cells[1, 4].Font.Size = 16;
                    ...
                    ExcelApp.Cells[2, 2].Font.Size = 16;
                    ...
                    ExcelApp.Cells[6, 2].Font.Size = 10;
                    ...
                    ExcelApp.Cells[6, 1].Font.Size = 10;
                    ...
                    for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
                    {
                        for (int j = 0; j < dataGridView1.Columns.Count; j++)
                        {
                            ...
                            {                                
                                ...
                                ExcelApp.Cells[6, i + 3].Font.Size = 8;
                            ...
                            if (j == 2)
                            {
                                ...
                                ExcelApp.Cells[5, i + 3].Font.Size = 10;
